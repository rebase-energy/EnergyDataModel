...
class TestChildren:
    ...
    def test_windfarm_children(self):
        t01 = edm.WindTurbine(name="T01", capacity=3.5)
        t02 = edm.WindTurbine(name="T02", capacity=3.5)
        farm = edm.WindFarm(name="Lillgrund", capacity=110, members=[t01, t02])
    ...
    def test_pvsystem_children(self):
        ...
        pv = edm.PVSystem(name="PV01", members=[arr])
    ...
    def test_building_children(self):
        ...
        building = edm.Building(name="B1", members=[hp])
    ...
    def test_house_children(self):
        ...
        house = edm.House(name="H1", members=[pv])
...
class TestToProperties:
    ...
    def test_pvsystem_excludes_members(self):
        ...
        pv = edm.PVSystem(name="PV01", capacity=10, surface_tilt=25,
                          surface_azimuth=180, members=[arr])
    ...
    def test_building_excludes_members(self):
        hp = edm.HeatPump(name="HP01", capacity=10, cop=3.0, energy_source="air")
        b = edm.Building(name="B1", type="commercial", members=[hp])
        props = b.to_properties()
        assert "members" not in props
